...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('/images/logo.png')}}" type="image/png"><title>Plasmo</title>
  </head>
  <body>
            ...
            <article class="daftar-rs d-flex container">
                <div class="daftar-upper d-flex flex-column" style="width: 30%;">
                    ...
                    <div class="list-group mt-3">
                        ...
                        <a href="/change-password-pendonor" class="list-group-item list-group-item-action setting active-setting active">Ganti Password</a>
