...
<html lang="en">
  <head>
    ...
    <title>Stok Plasma - Plasmo</title>
  </head>
  <body>
                    ...
                    <article class="rumah-sakit-content" style="flex: 1; min-width: 420px; max-width: 48%;">
                        ...
                        <div class="downer mt-3 d-flex flex-column">
                            ...
                            <div class="button mt-4 align-self-center">
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $hospital->hotline) }}?text={{ urlencode('Halo, saya ' . Auth::user()->name . ' dengan golongan darah ' . (Auth::user()->golongan_darah ?? '-') . '. Saya ingin mendonorkan plasma darah di ' . $hospital->name) }}" target="_blank">
